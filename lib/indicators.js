...
// Returns the entire EMA array (same length as input) needed by regime engine.
// The existing `ema()` returns only the final value; this returns all values.
...
// Returns { adx, plusDI, minusDI } for the last bar.
// Requires highs, lows, closes arrays of equal length, minimum period*2+1 bars.
...
module.exports = {
  sma, ema, emaArray, adx,
  rsi, bollinger, macd, stochRsi,
